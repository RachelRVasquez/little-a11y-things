    ...
    return (
        <section id="upcoming-features">
            ...
            <ul>
                ...
                <li>Add a copy feature on code snippets.</li>
            </ul>
            <hr/>
            <h2>Suggestions? Bugs? Feedback?</h2>
            <p>If you have any suggestions or have found bugs, feel free to open an issue on
                <a href="https://github.com/RachelRVasquez/little-a11y-things"
                   target="_blank"> my Github repository</a>. And
                if this tool has helped you in any way, <a href="mailto:rachel@rrvasquez.com" target="_blank">I'd love to hear about it</a>.</p>
        </section>
    );
}
