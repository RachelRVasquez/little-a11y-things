...
<button type="button" class="example-btn icon-text-left">
    <svg aria-hidden="true">...</svg> Left icon button
</button>
...
<button type="button" class="example-btn icon-text-right">
    Right icon button <svg aria-hidden="true">...</svg>
</button>
...
function DialogCodeMode() {
    return (
        <div className="visual-mode-content">
            ...
            <p className="tip no-margin"><b>Note:</b> Icons can be implemented in different ways. While my examples use
