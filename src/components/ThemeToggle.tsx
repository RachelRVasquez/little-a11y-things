function ThemeToggle() {
    ...
    return (
        <button onClick={toggleTheme} type="button" aria-label="Toggle between light and dark theme."
                id="btn-theme-toggle">
            <svg className="theme-icon" id="light-icon" aria-hidden="true" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                    <path d="M8 22H16" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"
                          strokeLinejoin="round"></path>
                    <path d="M5 19H19" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"
                          strokeLinejoin="round"></path>
                    <path d="M2 16H22" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"
                          strokeLinejoin="round"></path>
                    <path
                    ...
                    <path d="M12 2V3" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M22 12L21 12" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M3 12L2 12" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M19.0708 4.92969L18.678 5.32252" stroke="#ffffff" strokeWidth="1.5"
                          strokeLinecap="round"></path>
                    <path d="M5.32178 5.32227L4.92894 4.92943" stroke="#ffffff" strokeWidth="1.5"
                          strokeLinecap="round"></path>
                </g>
            </svg>
            <svg className="theme-icon" id="dark-icon" aria-hidden="true" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
