function ThemeToggle() {
    ...
    return (
        <button onClick={toggleTheme} type="button" aria-label="Toggle between light and dark theme."
                id="btn-theme-toggle">
            <span className="theme-icon" id="light-icon">
                <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g
                    id="SVGRepo_bgCarrier"
                    stroke-width="0"></g><g
                    id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g
                    id="SVGRepo_iconCarrier"> <path d="M12 2V3" stroke="#ffffff" stroke-width="1.5"
                                                    stroke-linecap="round"></path> <path d="M12 21V22" stroke="#ffffff"
                                                                                         stroke-width="1.5"
                                                                                         stroke-linecap="round"></path> <path
                    d="M22 12L21 12" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path
                    d="M3 12L2 12" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path
                    d="M19.0708 4.92969L18.678 5.32252" stroke="#ffffff" stroke-width="1.5"
                    stroke-linecap="round"></path> <path d="M5.32178 18.6777L4.92894 19.0706" stroke="#ffffff"
                                                         stroke-width="1.5" stroke-linecap="round"></path> <path
                    d="M19.0708 19.0703L18.678 18.6775" stroke="#ffffff" stroke-width="1.5"
                    stroke-linecap="round"></path> <path d="M5.32178 5.32227L4.92894 4.92943" stroke="#ffffff"
                                                         stroke-width="1.5" stroke-linecap="round"></path> <path
            ...
            <span className="theme-icon" id="dark-icon">
